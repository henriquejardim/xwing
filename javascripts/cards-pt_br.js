(function() {
  ...
  exportObj.codeToLanguage.pt_br = 'Português';
  ...
  exportObj.translations['Português'] = {
    ...
    slot: {
      ...
      "Cannon": "Canhão",
      "Crew": "Tripulação",
      "Elite": "Talento de Elite",
      "Missile": "Míssel",
      "System": "Sistema",
      "Torpedo": "Torpedo",
      "Turret": "Torre de Canhão",
      "Cargo": "Cargo",
      "Hardpoint": "Hardpoint",
      "Team": "Time",
      "Illicit": "Illicit",
    ...
    sources: {
      "Core": "Básico",
      "A-Wing Pacote de Expansão": "A-Wing Pacote de Expansão",
      "B-Wing Pacote de Expansão": "B-Wing Pacote de Expansão",
      "X-Wing Pacote de Expansão": "X-Wing Pacote de Expansão",
      "Y-Wing Pacote de Expansão": "Y-Wing Pacote de Expansão",
      "Millennium Falcon Pacote de Expansão": "Millennium Falcon Pacote de Expansão",
      "HWK-290 Pacote de Expansão": "HWK-290 Pacote de Expansão",
      "TIE Fighter Pacote de Expansão": "TIE Fighter Pacote de Expansão",
      "TIE Interceptor Pacote de Expansão": "TIE Interceptor Pacote de Expansão",
      "TIE Bomber Pacote de Expansão": "TIE Bomber Pacote de Expansão",
      "TIE Advanced Pacote de Expansão": "TIE Advanced Pacote de Expansão",
      "Lambda-Class Shuttle Pacote de Expansão": "Lambda-Class Shuttle Pacote de Expansão",
      "Slave I Pacote de Expansão": "Slave I Pacote de Expansão",
      "Imperial Aces Pacote de Expansão": "Imperial Aces Pacote de Expansão",
      "Rebel Transport Pacote de Expansão": "Rebel Transport Pacote de Expansão",
      "Z-95 Headhunter Pacote de Expansão": "Z-95 Headhunter Pacote de Expansão",
      "TIE Defender Pacote de Expansão": "TIE Defender Pacote de Expansão",
      "E-Wing Pacote de Expansão": "E-Wing Pacote de Expansão",
      "TIE Phantom Pacote de Expansão": "TIE Phantom Pacote de Expansão",
      "Tantive IV Pacote de Expansão": "Tantive IV Pacote de Expansão",
      "Rebel Aces Pacote de Expansão": "Rebel Aces Pacote de Expansão",
      "YT-2400 Freighter Pacote de Expansão": "YT-2400 Freighter Pacote de Expansão",
      "VT-49 Decimator Pacote de Expansão": "VT-49 Decimator Pacote de Expansão",
      "StarViper Pacote de Expansão": "StarViper Pacote de Expansão",
      "M3-A Interceptor Pacote de Expansão": "M3-A Interceptor Pacote de Expansão",
      "IG-2000 Pacote de Expansão": "IG-2000 Pacote de Expansão",
      "Most Wanted Pacote de Expansão": "Most Wanted Pacote de Expansão",
      "Imperial Raider Pacote de Expansão": "Imperial Raider Pacote de Expansão"
    },
    ui: {
    ...
    byCSSSelector: {
      ...
      '.xwing-card-browser option[value="source"]': 'Origem',
      '.xwing-card-browser option[value="type-by-points"]': 'Tipo (por pontos)',
      '.xwing-card-browser option[value="type-by-name"]': 'Tipo (by nome)',
      '.xwing-card-browser .translate.select-a-card': 'Selecione uma carta da lista da esquerda.',
      '.info-well .info-ship td.info-header': 'Nave',
      '.info-well .info-skill td.info-header': 'Habilidade',
      '.info-well .info-actions td.info-header': 'Ações',
      '.info-well .info-upgrades td.info-header': 'Melhorias',
      '.info-well .info-range td.info-header': 'Alcance',
      '.clear-squad': 'Novo Esquadrão',
      '.save-list': 'Salvar',
      '.save-list-as': 'Salvar Como...',
      '.delete-list': 'Excluir',
      '.backend-list-my-squads': 'Abrir um esquadrão',
      '.view-as-text': '<span class="hidden-phone"><i class="icon-print"></i>&nbsp;Imprimir/Exibir como </span>Text',
      '.randomize': 'Aleatório!',
      '.randomize-options': 'Opções de aleatorização…',
      '.bbcode-list': 'Copie o BBCode abaixo e cole no seu post do fórum.<textarea></textarea>',
      '.vertical-space-checkbox': "Adicione o as cartas de dano/melhoria para impressão <input type=\"checkbox\" class=\"toggle-vertical-space\" />",
      '.color-print-checkbox': "Cor de impressão <input type=\"checkbox\" class=\"toggle-color-print\" />",
      '.print-list': '<i class="icon-print"></i>&nbsp;Imprimir',
      '.do-randomize': 'Aleatorizar!',
      '#empireTab': 'Império Galático',
      '#rebelTab': 'Aliança Rebelde',
      '#scumTab': 'Scum and Villainy',
      '#browserTab': 'Visualizador de Cartas',
      '#aboutTab': 'Sobre'
    },
    singular: {
      'pilots': 'Piloto',
...
//@ sourceMappingURL=cards-pt_br.map